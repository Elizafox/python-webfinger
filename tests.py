...
class TestWebFingerResponse(unittest.TestCase):
    ...
    def test_rel_longname(self):
        self.assertEqual(self.response.rel('http://webfinger.net/rel/profile-page'), ['https://mst3k.interlinked.me/@Elizafox'])

    def test_rel_shortname(self):
        self.assertEqual(self.response.rel('profile'), ['https://mst3k.interlinked.me/@Elizafox'])
